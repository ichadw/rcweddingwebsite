...
const SectionBanner = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setTimeLeft(current => {
        ...
        let days = Math.floor((seconds % mth) / d);
        let hours = Math.floor((seconds % d) / h);
  ...
  return (
    <section className={MainSectionContainer} id="top">
      <div className={MainSectionWrapper}>
        ...
        <div className={MainSectionText}>
          ...
          <p>are getting married on 29 September 2019</p>
        </div>
